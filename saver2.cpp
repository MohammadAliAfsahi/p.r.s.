...
struct players_info{
	char number[60][100];
	char player_name[60][100];
	char player_age[60][100];
	char player_post[60][100];
	char player_skill[60][100];
	char player_form[60][100];
	char player_fitness[60][100];
...
int main() {
	...
	if(j%6==0){
		strcpy(std[s1].name_country[s1],name);
		b[s1]=s1+1;
		s1++;
		}
		if(j%6 == 1){
		strcpy(std[s2].group[s2],name);
		s2++;
		
		}
		if(j%6==2){
		strcpy(std[s3].num[s3],name);
		s3++;
		}
		if(j%6==3){
		strcpy(std[s4].fedrasion[s4],name);
		s4++;
		}

		if(j%6==4){
		strcpy(std[s5].sid[s5],name);
		s5++;
		
		}
		if(j%6==5){
		strcpy(std[s6].filename[s6],name);
		s6++;
		}
	j++;
	i++;
